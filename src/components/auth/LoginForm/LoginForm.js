...
export const LoginForm = ({changeRegisterForm,setChangeRegisterForm}) => {
        ...
        <>
            <div className='md:flex w-3/4 bg-[#424769] flex-col border-l-2 border-orange-300' >
                <div className='p-4 flex flex-col w-full md:flex-row md:space-y-0 md:space-x-6 md:h-24 h-20 relative'>
                    <input type="text" id='email' placeholder='Email' className='w-full h-full p-2 bg-[#424769] text-white outline-none peer relative placeholder-transparent focus:outline-1' />
                    <label htmlFor="email"
...
'>Email</label>
            ...
            <div className='md:flex w-3/4 bg-[#424769] flex-col my-4 border-l-2 border-orange-300' >
                <div className='p-4 flex flex-col w-full md:flex-row md:space-y-0 md:space-x-6 md:h-24 h-20 relative'>
                    <input type="password" id='password' placeholder='Password' className='w-full h-full p-2 bg-[#424769] text-white outline-none peer relative placeholder-transparent focus:outline-1 ' />
...
'>Password</label>
            ...
            <button onClick={handleChangeView} className='flex w-3/4 text-gray-500 text-sm justify-end'>Dont have account?</button>
